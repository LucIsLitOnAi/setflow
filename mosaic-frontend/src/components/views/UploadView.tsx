...
export const UploadView = () => {
  ...
  const processFiles = (files: File[], type: 'main' | 'tiles') => {
    // Validate files (basic check)
    ...
    if (type === 'main' && validFiles.length > 0) {
      ...
      dispatch({ type: 'ADD_TILE_IMAGES', payload: newLocalImages });
    }
  };
  ...
  return (
    ...
    >
          ...
          >
            {state.upload.mainImage ? (
              ...
              <>
                ...
                <p className="text-xs text-gray-400 mb-4">Max 10MB (JPG/PNG/WEBP)</p>
      ...
      <motion.button
        ...
        className={`mt-12 px-10 py-4 rounded-full text-xl font-medium transition-all ${
          isReady
